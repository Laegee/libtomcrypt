...
int main(void)
{
   ...
   if ((err = ecc_make_key(&prng, find_prng("yarrow"), 24, &mykey))             XXX-FIXME
       != CRYPT_OK) {
...
int main(void)
{
   ...
   /* make a 192-bit ECC key */
   if ((err = ecc_make_key(NULL, find_prng("sprng"), 24, &mykey))       XXX-FIXME
       != CRYPT_OK) {
      printf("Error making key: %s\n", error_to_string(err));
      return -1;
   }
...
XXX-FIXME As of v1.19 ... the old format is obsolete we supported several standard formats
...
XXX-FIXME As of v1.19 ... ltc\_ecc\_set\_type replaced by ltc\_ecc\_curve
...
XXX-FIXME As of v1.19 ... new style
...
XXX-FIXME As of v1.19 ... more export features
...
XXX-FIXME As of v1.19 ... more import features
